...
### LSTM 네트워크 
Long Short Term Memory 네트워크 (일반적으로 "LSTM"이라고 함)는 특별한 종류의 RNN이며 장기 의존성을 학습할 수 있도록 설계되었다. 이것은 Hochreiter & Schmidhuber (1997)에 의해 소개되었고 다음과 같은 작업에서 많은 사람들이 세련되고 대중화되었습니다 .1 이들은 다양한 문제에 대해 대단히 잘 작동하며 현재 널리 사용되고 있습니다.
